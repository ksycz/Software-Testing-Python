...
class FieldsTest(unittest.TestCase):
    ...
    def test_first_name(self):
        ...
        firstNameFilledIn = '//*[@id="id123-control33873733" and @class="no-validation-error"]' #I look for ID and validation class
        ...
        WebDriverWait(driver, 10).until(lambda driver: driver.find_element_by_xpath(firstNameFilledIn))
    ...
    def test_last_name(self):
        ...
        lastNameFilledIn = '//*[@id="id123-control33873751" and @class="no-validation-error"]' #I look for ID and validation class
        ...
        WebDriverWait(driver, 10).until(lambda driver: driver.find_element_by_xpath(lastNameFilledIn))
    ...
    def test_email_correct(self):
        ...
        submitButtonTagName = 'button'
        emailFieldFilledIn = '//*[@id="id123-control33865730" and @class="no-validation-error"]' #I look for ID and validation class
        ...
        WebDriverWait(driver, 10).until(lambda driver: driver.find_element_by_xpath(emailFieldFilledIn))
    ...
    def test_select_checkboxes(self):
        ...
        for i in range(5):
            try:
                driver.find_element_by_name('control33865757-0').click()
                driver.find_element_by_name('control33865757-1').click()
                driver.find_element_by_name('control33865757-2').click()
                driver.find_element_by_name('control33865757-3').click()
                driver.find_element_by_name('control33865757-4').click()
                driver.find_element_by_name('control33865757-5').click()
                break
            except NoSuchElementException as e:
                print("Retry")
                time.sleep(1)
